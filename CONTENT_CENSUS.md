...
| Encounter kinds | 26 | 26 | terrain/season/rarity-gated spawn, distinct action sets; non-human peoples barter in-kind, no coin, fixed rate: **KhorTrader** (#443, cold Tundra/Mountain, härkä goods Hide+Food for metal) and **MerakTrader** (#445, Coast tideline, deep-fish Food + deep-glass Glass for cloth/tools) |
