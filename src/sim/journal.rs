...
static TRAVEL_DAY: &[&str] = &[
    "The sun hung overhead. I walked the long bend in the road.",
    "Another stretch of open ground behind me. The day was long.",
    "The road went on and I followed. That is all there is to say.",
    "Hours passed under open sky. I did not look back.",
    "I walked until the shadows shortened. Then I kept walking.",
];
