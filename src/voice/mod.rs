...
fn craft_flavor(craft: &str) -> &'static str {
    match craft {
        ...
        "tanner" => "hide-scraped knuckles",
        "rope_maker" => "fibrous calluses",
        "charcoal_burner" => "soot-blackened palms",
        "falconer" => "glove-creased grip",
        "salt_miner" => "crystal-dusted skin",
        "reed_weaver" => "reed-sliced fingertips",
        _ => "calloused hands",
    }
}
...
fn profession_flavor(profession: &str) -> &'static str {
    match profession {
        ...
        "trader" => "road-wise",
        "sailor" => "wave-carved",
        "weaver" => "thread-fingered",
        "carpenter" => "saw-dusted",
        "miner" => "dust-veined",
        "soldier" => "scar-earned",
        "healer" => "herb-scented",
        "scribe" => "ink-stained",
        "priest" => "incense-shadowed",
        "hearth-keeper" => "hearth-warmed",
        "path-finder" => "trail-read",
        "fence-builder" => "post-worn",
        "beast-handler" => "callus-gripped",
        "singer" => "song-roughened",
        _ => "steady-eyed",
    }
}
